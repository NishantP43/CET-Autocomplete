...
## 0.0.10 New features
- I made `obj.` list that class's methods, including ones inherited from its `extends` parents — mine first, inherited ones after.
- I insert the picked method with its parameters ready to edit.
- I added Emacs-style CM reindenting: 4-space levels, tabs turned into spaces, trailing spaces stripped.
- I let you run it with Ctrl+Alt+\, the Reindent/Untabify command, or Format Document.
